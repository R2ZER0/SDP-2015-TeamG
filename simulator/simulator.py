...
class SimulatedAction:
    ...
    def __init__(self, robot):
        ...
        comm = serial.Serial('/dev/ttyACM1', 115200, timeout=1)
        comm.flushInput()
    ...
    def move(self, angle, scale=64):
        ...
        self.robot_actual.move(angle, scale)
    ...
    def turnBy(self, angle, scale=64):
        ...
        '''
        self.robot_actual.turnBy(angle)
    ...
    def open_catcher(self, scale=100):
        ...
        '''
        self.robot_actual.open_catcher()
...
class Simulator():
    ...
    def __init__(self, side, role, color):
        ...
        self.ball = SimulatedBall(self.space, (self.pitch.PITCH_LENGTH*4/5,self.pitch.PITCH_WIDTH/2))
